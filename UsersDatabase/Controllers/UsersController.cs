...
namespace UsersDatabase.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        [HttpGet]
        [Route("useremail")]
        public IActionResult FilterByEmail(string email)
        {
            var result = _userRepository.FilterEmail(email);
        ...
        public IActionResult GetRoleByID(int roleId)
        {
            ...
            var user = _roleRepository.GetRole(roleId);
        ...
        public IActionResult GetRole(string roleName)
        {
            ...
            var user = _roleRepository.GetRole(roleName);
        ...
        [HttpPost]
        [Route("{id}/AddUser/{userId}", Name = nameof(AddUser))]
        public ActionResult<bool> AddUser([FromQuery] int roleId, [FromQuery] int userId)
        {
